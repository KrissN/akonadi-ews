...
#ifndef EWSSEARCHFOLDER_H
#define EWSSEARCHFOLDER_H

#include "ewsfolderbase.h"

class EwsSearchFolderPrivate;

class EwsSearchFolder : public EwsFolderBase
{
    Q_OBJECT
public:
...
private:
    EwsSearchFolder(QSharedDataPointer<EwsFolderBasePrivate> priv, EwsClient *parent);
