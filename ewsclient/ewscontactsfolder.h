...
#ifndef EWSCONTACTSFOLDER_H
#define EWSCONTACTSFOLDER_H

#include "ewsfolderbase.h"

class EwsContactsFolderPrivate;

class EwsContactsFolder : public EwsFolderBase
{
    Q_OBJECT
public:
...
private:
    EwsContactsFolder(QSharedDataPointer<EwsFolderBasePrivate> priv, EwsClient *parent);
