...
static const QVector<EwsItemPrivate::Reader::Item> ewsItemItems = {
    {EwsItemFieldMimeContent, QStringLiteral("MimeContent"), ewsTypeNsUri, &ewsXmlBase64Reader},
    {EwsItemFieldItemId, QStringLiteral("ItemId"), ewsTypeNsUri, &ewsXmlIdReader},
    {EwsItemFieldParentFolderId, QStringLiteral("ParentFolderId"), ewsTypeNsUri, &ewsXmlIdReader},
    {EwsItemFieldItemClass, QStringLiteral("ItemClass"), ewsTypeNsUri, &ewsXmlTextReader},
    {EwsItemFieldSubject, QStringLiteral("Subject"), ewsTypeNsUri, &ewsXmlTextReader},
    {EwsItemFieldSensitivity, QStringLiteral("Sensitivity"), ewsTypeNsUri, &ewsXmlSensitivityReader},
    {EwsItemFieldBody, QStringLiteral("Body"), ewsTypeNsUri, &EwsItemPrivate::bodyReader},
    {EwsItemFieldSize, QStringLiteral("Size"), ewsTypeNsUri, &ewsXmlUIntReader},
    {EwsItemFieldInternetMessageHeaders, QStringLiteral("InternetMessageHeaders"), ewsTypeNsUri,
    ...
    {EwsItemFieldImportance, QStringLiteral("Importance"), ewsTypeNsUri, &ewsXmlImportanceReader},
    {EwsItemFieldFrom, QStringLiteral("From"), ewsTypeNsUri, &EwsItemPrivate::mailboxReader},
    {EwsItemFieldToRecipients, QStringLiteral("ToRecipients"), ewsTypeNsUri, &EwsItemPrivate::recipientsReader},
    {EwsItemFieldCcRecipients, QStringLiteral("CcRecipients"), ewsTypeNsUri, &EwsItemPrivate::recipientsReader},
    {EwsItemFieldBccRecipients, QStringLiteral("BccRecipients"), ewsTypeNsUri, &EwsItemPrivate::recipientsReader},
    {EwsItemFieldIsRead, QStringLiteral("IsRead"), ewsTypeNsUri, &ewsXmlBoolReader},
    {EwsItemFieldHasAttachments, QStringLiteral("HasAttachments"), ewsTypeNsUri, &ewsXmlBoolReader},
    {EwsItemFieldIsFromMe, QStringLiteral("IsFromMe"), ewsTypeNsUri, &ewsXmlBoolReader},
    {EwsItemFieldCalendarItemType, QStringLiteral("CalendarItemType"), ewsTypeNsUri,
        &ewsXmlCalendarItemTypeReader},
    {EwsItemFieldUID, QStringLiteral("UID"), ewsTypeNsUri, &ewsXmlTextReader},
    {EwsItemFieldCulture, QStringLiteral("Culture"), ewsTypeNsUri, &ewsXmlTextReader},
    {EwsItemFieldStartTimeZone, QStringLiteral("StartTimeZone"), ewsTypeNsUri, &EwsItemPrivate::timezoneReader},
    {EwsItemFieldOrganizer, QStringLiteral("Organizer"), ewsTypeNsUri, &EwsItemPrivate::mailboxReader},
    {EwsItemFieldRequiredAttendees, QStringLiteral("RequiredAttendees"), ewsTypeNsUri,
        &EwsItemPrivate::attendeesReader},
    {EwsItemFieldOptionalAttendees, QStringLiteral("OptionalAttendees"), ewsTypeNsUri,
        &EwsItemPrivate::attendeesReader},
    {EwsItemFieldResources, QStringLiteral("Resources"), ewsTypeNsUri, &EwsItemPrivate::attendeesReader},
    {EwsItemFieldStart, QStringLiteral("Start"), ewsTypeNsUri, &ewsXmlDateTimeReader},
    {EwsItemFieldEnd, QStringLiteral("End"), ewsTypeNsUri, &ewsXmlDateTimeReader},
    {EwsItemFieldRecurrenceId, QStringLiteral("RecurrenceId"), ewsTypeNsUri, &ewsXmlDateTimeReader},
    {EwsItemFieldIsAllDayEvent, QStringLiteral("IsAllDayEvent"), ewsTypeNsUri, &ewsXmlBoolReader},
    {EwsItemFieldLegacyFreeBusyStatus, QStringLiteral("LegacyFreeBusyStatus"), ewsTypeNsUri,
        &ewsXmlLegacyFreeBusyStatusReader},
    {EwsItemFieldMyResponseType, QStringLiteral("MyResponseType"), ewsTypeNsUri, &ewsXmlResponseTypeReader},
    {EwsItemFieldAppointmentSequenceNumber, QStringLiteral("AppointmentSequenceNumber"), ewsTypeNsUri,
        &ewsXmlUIntReader},
    {EwsItemFieldRecurrence, QStringLiteral("Recurrence"), ewsTypeNsUri, &EwsItemPrivate::recurrenceReader},
    {EwsItemFieldFirstOccurrence, QStringLiteral("FirstOccurrence"), ewsTypeNsUri,
        &EwsItemPrivate::occurrenceReader},
    {EwsItemFieldLastOccurrence, QStringLiteral("LastOccurrence"), ewsTypeNsUri,
        &EwsItemPrivate::occurrenceReader},
    {EwsItemFieldModifiedOccurrences, QStringLiteral("ModifiedOccurrences"), ewsTypeNsUri,
        &EwsItemPrivate::occurrencesReader},
    {EwsItemFieldDeletedOccurrences, QStringLiteral("DeletedOccurrences"), ewsTypeNsUri,
        &EwsItemPrivate::occurrencesReader},
    {EwsItemFieldCategories, QStringLiteral("Categories"), ewsTypeNsUri, &EwsItemPrivate::categoriesReader},
};
...
bool EwsItem::readBaseItemElement(QXmlStreamReader &reader)
{
    ...
    if (!d->mEwsReader.readItem(reader, "Item")) {
        return false;
    }
